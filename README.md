...
При продлении вам может потребоваться предоставить обратный билет. [Оформление обратного билета](#оформление-обратного-билета)
...
1. [Обратный билет](#оформление-обратного-билета). Пункт на сайте Иммиграционной службы Шри-Ланки
...
- Лекарственные препараты
  > Не все препараты могут быть в наличии, что-то можно заказать. Нужно искать аналоги на местные препараты (помочь с поиском аналагов могут в [подчатах](#чаты))
...
В соответствующих [чатах](#чаты) встречаются объявления о аренде вилл/домов/коливингов/номера.
...
Аренда мопедов можно найти почти везде или обратиться в [подчаты](#чаты). Стоимость в сутки 2000-4000 LKR, в месяц 100-250$ в зависимости от состояния и мощности байка.  
...
| Арендодатор повредил транспорт, а арендодатель требует 2-х кратную компенсацию за ремонт, пытаясь заработать на вас | Если в договоре не прописана процедура, то можно самостоятельно обратиться в сервис за ремонтом. Если конфликт не удается решить, обращайтесь в [полицию](#туристическая) |
...
| Врезались в объект без участия других транспортных средств | Если получили травму, то вызовите [скорую](#скорая-помощь), после свяжитесь с пунктом проката, чтобы забрал байк |
| ДТП с участием другого транспортного средства | Если получили травму, то вызовите [скорую](#скорая-помощь), после свяжитесь с пунктом проката |
...
В [чатах](#чаты) можно встретить объявления услуг по помощи оформлении водительского удостоверения. Легальность данных услуг неизвестна.
...
- В парикмахерских мужская стрижка обойдется 800-2000 LKR у локалов. Порекомендовать парикмахеров вам могут в [чатах](#чаты), там же сможете найти отечественных мастеров.
...
В [подчатах](#чаты) можете найти предложения экскурсий или запросить по интересующим вам местам. Ценник здесь будет адекватным. Гид будет русскоговорящий (скорей всего ланкиец).
