...
2. [Обратный билет](../other.md#оформление-обратного-билета).
   :::caution
   ...
   :::
3. По прилету заполнить Arrival card, который получайте рядом с паспортным столом. [Пример заполнения](/img/arrival-card.jpg).
